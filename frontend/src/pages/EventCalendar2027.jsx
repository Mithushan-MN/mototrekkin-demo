...
import eventBanner1 from '../assets/america larger.webp';
import eventBanner2 from '../assets/ROAD-RALLYE-2027.webp';
import eventBanner3 from '../assets/NZSI-BANNERS-2026.webp';

const EventCalendar2027 = () => {
  return (
    <div className=" py-12 px-4 max-w-5xl mx-auto">
      <h2 className="text-5xl font-bold text-center text-gray-800 mb-6">2027 EVENT CALENDAR</h2>
      <hr className="w-30 border-t-3 border-yellow-500 mx-auto mb-6" />
      <p className="text-center text-gray-600 mb-4">
        GET READY FOR AN EXHILARATING RIDE AS WE GEAR UP FOR THE MOTO TREKKIN 2027 EVENTS!
      </p>
      <p className="text-center text-gray-600 mb-4">
      ...
      <p className="text-center text-gray-600 mb-6">
        The rumble of engines, the thrill of the trails, and the camaraderie of fellow riders await you. Join us on this epic ride at Moto Trekkin 2027 Events - it's time to rev up and make memories that will last a lifetime!
      </p>
...
export default EventCalendar2027