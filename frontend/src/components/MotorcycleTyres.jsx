...
import tyrebgMobile from "../assets/tyre-banner-mobile.webp";       // Create this (cropped for mobile)
  ...
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${tyrebgDesktop})` }}
      />

      {/* Mobile Image - hidden on desktop */}
      <div
        className="absolute inset-0 lg:hidden bg-cover bg-center bg-fixed"
        style={{ backgroundImage: `url(${tyrebgMobile})` }}
      />
      ...
      {/* Spinning accent rings - only visible on larger screens */}
