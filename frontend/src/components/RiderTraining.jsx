import TRAININGbg from "../assets/TRAINING-PAGE.webp"
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 transform transition-all duration-1000 hover:scale-105">
        <div className="animate-fade-in-up mt-56">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold max-w-5xl text-yellow-500 mb-8 drop-shadow-2xl leading-tight">
