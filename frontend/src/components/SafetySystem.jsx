import SafetySystembgDesktop from "../assets/safetysystems2-2.webp";           // Your current wide image
import SafetySystembgMobile from "../assets/safetysystems2-mobile2.webp";       // Create this (mobile-optimized)
