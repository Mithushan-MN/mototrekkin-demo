...
const NZSIRegistrationFormRefactored = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (token) {
        try {
          console.log('NZSIRegistrationFormRefactored: Fetching user profile for prefill');
          ...
          console.log('NZSIRegistrationFormRefactored: Profile prefilled');
        } catch (err) {
          console.error('NZSIRegistrationFormRefactored: Profile fetch failed', err);
        } finally {
