...
export const validate = (formData) => {
  ...
  // ---- birthday ------------------------------------------------
  if (!formData.birthday) errors.birthday = 'Date of birth is required';
...
const Step1PersonalDetails = ({
  ...
  const handleSubmit = (e) => {
    ...
    // optional: run your own validation
        ...
        <form ref={formRef} onSubmit={handleSubmit} noValidate>
          ...
          <section className="mb-16">
            ...
            <div className="space-y-6">
              ...
              {/* birthday – single date input */}
              <div className={errors.birthday ? 'ring-2 ring-red-200 rounded-lg p-2 bg-red-50/30' : ''}>
                <label className="block text-sm font-semibold text-gray-700 mb-2">
