    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 sm:p-4 mb-4 sm:mb-6">
        <p className="text-xs sm:text-sm text-yellow-800 font-semibold">
          <strong>THIS IS THE RidgeRiderVI EVENT REGISTRATION PAGE - THIS IS NOT THE PAGE TO REQUEST EVENT INFORMATION. To request information about this event CLICK HERE</strong>
        </p>
      </div>

      <div className="space-y-3 sm:space-y-4 text-gray-700">
        <p className="text-base sm:text-lg">
          Welcome to the RidgeRiderVI 2026 registration page!
        </p>
