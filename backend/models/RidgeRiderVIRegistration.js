// models/RidgeRiderVIRegistration.js
import mongoose from 'mongoose';

const RidgeRiderVIRegistrationSchema = new mongoose.Schema(
  {
...
export default mongoose.model('RidgeRiderVIRegistration', RidgeRiderVIRegistrationSchema);